...
export const releases = [
  {
    ...
    version: "unreleased",
    date: "",
    name: "Embodied Data Public Switch",
    summary: "将具身数据生产公开站切换为证据可回链、边界可审计的全链路认知系统。",
    capabilities: [
      "具身数据关键变化",
      "六阶段生产管线",
      "数据资产与标准",
    ...
    changes: [
      ...
      "公开产品从通用 AI 行业信息流切换为具身数据生产全链路认知系统，围绕关键变化、六阶段管线、数据资产、同行能力、来源覆盖与行动建议六个视图组织可回链 Event；已补齐 2025-04 至 2026-09 的已核验事件与原始证据。",
      ...
      "公开导出只包含 allowlist DTO；历史通用 AI 数据、原始 payload、数据库字段、管理备注和保留的 provenance 不进入 Pages。",
      "中英文页面、事件详情、JSON DTO、Sitemap、RSS、llms.txt 与公开内容指纹统一使用具身数据领域契约；旧六主线、模型价格与旧路由泄漏会阻断发布。",
